...
```{r echo=FALSE}
ggplot(Final) +
  geom_point(aes(x = coef , y = Dead, color = Area)) +
  geom_smooth(aes(x = coef, y = Dead))

ggplot(Final) +
  geom_point(aes(x = coef , y = Dead, color = Gunlaws)) +
  geom_smooth(aes(x = coef, y = Dead))

ggplot(Final) +
  geom_point(aes(x = coef , y = Dead, color = Ethnicity)) +
  geom_smooth(aes(x = coef, y = Dead))


ggplot(Final) +
  geom_point(aes(x = coef , y = Injured, color = Area)) +
  geom_smooth(aes(x = coef, y = Injured))

ggplot(Final) +
  geom_point(aes(x = coef , y = Injured, color = Gunlaws)) +
  geom_smooth(aes(x = coef, y = Injured))

ggplot(Final) +
  geom_point(aes(x = coef , y = Injured, color = Ethnicity)) +
  geom_smooth(aes(x = coef, y = Injured))
```
